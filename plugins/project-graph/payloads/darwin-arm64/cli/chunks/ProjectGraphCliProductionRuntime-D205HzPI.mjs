import { c as prepareBuiltInToolInvocation } from "./BuiltInToolRegistry-Dl_dIFF8.mjs";
...
function invokeClosedProjectToolInProduction(options) {
	return runClosedProjectRuntime(async () => {
		const { invokeClosedProjectTool, loadPrecompiledClosedProjectModule } = await import("./ClosedProjectInvocation-DkRLARLf.mjs");
