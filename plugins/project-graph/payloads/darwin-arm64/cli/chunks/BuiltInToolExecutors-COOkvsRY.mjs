import { G as Vector, U as Rectangle, X as Color, a as Entity, i as CollisionBox } from "./ProjectUpgrader-C2CEsQ4r.mjs";
import { n as ConnectableEntity } from "./effectObject-Aw49CpeT.mjs";
...
import { t as TextNode } from "./TextNode-J5nhkvXA.mjs";
...
addExecutor("search_and_add_image_node", () => async (project, { query, preferredOrientation, maxDisplaySize }, references, { abortSignal }) => {
	const [imageUtils, imageNodeFactory, entityDetailsManager, openverseImageSearch] = await Promise.all([
		import("./imageUtils-1KZr1GsA.mjs"),
		import("./imageNodeFactory-B5zd-YaN.mjs"),
...
addExecutor("recognize_image", () => async (project, { ref, prompt }, references) => {
	const [{ encodeModelImageDataUrl }, { Settings }] = await Promise.all([import("./ClosedProjectModelImageEncoder-CDh2DMJL.mjs"), import("./ClosedProjectSettings-BN_tMSHv.mjs")]);
...
async function recognizeImage(dataUrl, prompt) {
	...
	const [{ Settings }, { createOpenAICompatible }, { fetch }, { generateText }] = await Promise.all([
		import("./ClosedProjectSettings-BN_tMSHv.mjs"),
