...
import { R as toast, et as __decorate, nt as deserialize, st as serialize, tt as __decorateMetadata } from "./ProjectUpgrader-CJFD-Z4z.mjs";
import { ar as Slot, ir as cx, n as ProjectState, r as service, t as Project } from "./Project-CX2Ju4hB.mjs";
import { n as require_react, t as require_react_dom } from "./react-dom-I8_g7zx2.mjs";
import { r as require_jsx_runtime, t as twMerge } from "./bundle-mjs-CFgt2SnT.mjs";
/**
...
*/
//#endregion
//#region ../node_modules/.pnpm/@udecode+react-utils@52.3.4_@types+react@19.2.14_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/@udecode/react-utils/dist/index.js
var import_dist = (/* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var _a;
	var ReactSecretInternals = (_a = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE) != null ? _a : React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
	var $empty = Symbol.for("react.memo_cache_sentinel");
	var _a2;
	var c = typeof ((_a2 = React.__COMPILER_RUNTIME) == null ? void 0 : _a2.c) === "function" ? React.__COMPILER_RUNTIME.c : function c2(size) {
		return React.useMemo(() => {
			const $ = new Array(size);
			for (let ii = 0; ii < size; ii++) $[ii] = $empty;
			$[$empty] = true;
			return $;
		}, []);
	};
	...
	LazyGuardDispatcher["useMemoCache"] = (count) => {
		if (originalDispatcher == null) throw new Error("React Compiler internal invariant violation: unexpected null dispatcher");
		else return originalDispatcher.useMemoCache(count);
	};
	...
	function $dispatcherGuard(kind) {
		...
		if (kind === 0) {
			...
			if (guardFrames.length === 1) originalDispatcher = curr;
			if (curr === LazyGuardDispatcher) throw new Error(`[React] Unexpected call to custom hook or component from a React compiled function. Check that (1) all hooks are called directly and named according to convention ('use[A-Z]') and (2) components are returned as JSX instead of being directly invoked.`);
			setCurrent(LazyGuardDispatcher);
		} else if (kind === 1) {
			const lastFrame = guardFrames.pop();
			if (lastFrame == null) throw new Error("React Compiler internal error: unexpected null in guard stack");
			if (guardFrames.length === 0) originalDispatcher = null;
			...
			if (lastFrame == null) throw new Error("React Compiler internal error: unexpected null in guard stack");
			setCurrent(lastFrame);
		} else throw new Error("React Compiler internal error: unreachable block" + kind);
	}
	function $reset($) {
		for (let ii = 0; ii < $.length; ii++) $[ii] = $empty;
	}
	...
	function clearRenderCounterRegistry() {
		for (const counters of renderCounterRegistry.values()) counters.forEach((counter) => {
			counter.count = 0;
		});
	}
	...
	function useRenderCounter(name) {
		...
		if (val.current != null) val.current.count += 1;
		useEffect(() => {
			if (val.current == null) {
			...
			return () => {
				if (val.current !== null) removeRenderCounter(name, val.current);
			};
		});
	}
	...
	function $structuralCheck(oldValue, newValue, variableName, fnName, kind, loc) {
		...
		function recur(oldValue2, newValue2, path, depth) {
			...
			else if (oldValue2 === newValue2) return;
			else if (typeof oldValue2 !== typeof newValue2) error(`type ${typeof oldValue2}`, `type ${typeof newValue2}`, path, depth);
			else if (typeof oldValue2 === "object") {
				const oldArray = Array.isArray(oldValue2);
				const newArray = Array.isArray(newValue2);
				if (oldValue2 === null && newValue2 !== null) error("null", `type ${typeof newValue2}`, path, depth);
				else if (newValue2 === null) error(`type ${typeof oldValue2}`, "null", path, depth);
				else if (oldValue2 instanceof Map) if (!(newValue2 instanceof Map)) error(`Map instance`, `other value`, path, depth);
				else if (oldValue2.size !== newValue2.size) error(`Map instance with size ${oldValue2.size}`, `Map instance with size ${newValue2.size}`, path, depth);
				else for (const [k, v] of oldValue2) if (!newValue2.has(k)) error(`Map instance with key ${k}`, `Map instance without key ${k}`, path, depth);
				else recur(v, newValue2.get(k), `${path}.get(${k})`, depth + 1);
				else if (newValue2 instanceof Map) error("other value", `Map instance`, path, depth);
				else if (oldValue2 instanceof Set) {
					if (!(newValue2 instanceof Set)) error(`Set instance`, `other value`, path, depth);
					else if (oldValue2.size !== newValue2.size) error(`Set instance with size ${oldValue2.size}`, `Set instance with size ${newValue2.size}`, path, depth);
					else for (const v of newValue2) if (!oldValue2.has(v)) error(`Set instance without element ${v}`, `Set instance with element ${v}`, path, depth);
				} else if (newValue2 instanceof Set) error("other value", `Set instance`, path, depth);
				else if (oldArray || newArray) if (oldArray !== newArray) error(`type ${oldArray ? "array" : "object"}`, `type ${newArray ? "array" : "object"}`, path, depth);
				else if (oldValue2.length !== newValue2.length) error(`array with length ${oldValue2.length}`, `array with length ${newValue2.length}`, path, depth);
				else for (let ii = 0; ii < oldValue2.length; ii++) recur(oldValue2[ii], newValue2[ii], `${path}[${ii}]`, depth + 1);
				else if (isValidElement(oldValue2) || isValidElement(newValue2)) if (isValidElement(oldValue2) !== isValidElement(newValue2)) error(`type ${isValidElement(oldValue2) ? "React element" : "object"}`, `type ${isValidElement(newValue2) ? "React element" : "object"}`, path, depth);
				else if (oldValue2.type !== newValue2.type) error(`React element of type ${oldValue2.type}`, `React element of type ${newValue2.type}`, path, depth);
				else recur(oldValue2.props, newValue2.props, `[props of ${path}]`, depth + 1);
				else {
					for (const key in newValue2) if (!(key in oldValue2)) error(`object without key ${key}`, `object with key ${key}`, path, depth);
					for (const key in oldValue2) if (!(key in newValue2)) error(`object with key ${key}`, `object without key ${key}`, path, depth);
					else recur(oldValue2[key], newValue2[key], `${path}.${key}`, depth + 1);
				}
			} else if (typeof oldValue2 === "function") return;
			else if (isNaN(oldValue2) || isNaN(newValue2)) {
				if (isNaN(oldValue2) !== isNaN(newValue2)) error(`${isNaN(oldValue2) ? "NaN" : "non-NaN value"}`, `${isNaN(newValue2) ? "NaN" : "non-NaN value"}`, path, depth);
			} else if (oldValue2 !== newValue2) error(oldValue2, newValue2, path, depth);
		}
...
require_react_dom();
var createSlotComponent = (element) => import_react.forwardRef((t0, ref) => {
	const $ = (0, import_dist.c)(8);
	let as;
	let props;
	let t1;
	if ($[0] !== t0) {
	...
	if ($[4] !== Comp || $[5] !== props || $[6] !== ref) {
		t2 = /* @__PURE__ */ import_react.createElement(Comp, {
			ref,
			...props
		});
		$[4] = Comp;
...
import_react.memo((t0) => {
	const $ = (0, import_dist.c)(2);
	const { children } = t0;
	let t1;
	if ($[0] !== children) {
		t1 = /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, children);
		$[0] = children;
		$[1] = t1;
	} else t1 = $[1];
	return t1;
...
typeof window !== "undefined" && window.document?.createElement !== void 0 ? import_react.useLayoutEffect : import_react.useEffect;
//#endregion
//#region ../node_modules/.pnpm/@udecode+cn@52.3.4_@types+react@19.2.14_class-variance-authority@0.7.1_react-dom@19.2.7_27ced0eaf1b3dc088b38f94f6d2beeb2/node_modules/@udecode/cn/dist/index.js
	...
	prepareDeltaResult(result) {
		...
		if (typeof result === "object") {
			...
			if ((_b = this.options) === null || _b === void 0 ? void 0 : _b.cloneDiffValues) {
				...
				if (typeof result[0] === "object") result[0] = clone$1(result[0]);
				if (typeof result[1] === "object") result[1] = clone$1(result[1]);
			}
		}
		return result;
	}
...
var UNSAFE_KEYS = new Set(["__proto__"]);
...
function diff(left, right) {
	if (!defaultInstance) defaultInstance = new DiffPatcher();
...
//#endregion
//#region src/core/stage/stageManager/StageHistoryManager.tsx
var import_lodash = /* @__PURE__ */ __toESM(require_lodash(), 1);
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime(), 1);
var HistoryManagerAbs = class {};
var HistoryManagerTimeEfficient = class extends HistoryManagerAbs {
	project;
	/**
	* 初始化的舞台数据
	*/
	...
	*/
	estimateMemoryUsage() {
		try {
			const bytes = JSON.stringify(this.history).length * 2;
	...
	*/
	undo() {
		...
		if (Settings.showDebug) toast(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex text-sm",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "m-2 flex flex-col justify-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "当前历史位置" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn(this.currentIndex === -1 && "text-red-500"),
						children: this.currentIndex + 1
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "m-2 flex flex-col justify-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "当前历史长度" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn(this.history.length === Settings.historySize && "text-yellow-500"),
						children: this.history.length
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "m-2 flex flex-col justify-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "限定历史长度" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "opacity-50",
						children: Settings.historySize
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "m-2 flex flex-col justify-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "内存占用估算" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-blue-500",
						children: this.estimateMemoryUsage()
					})]
				})
			]
		}));
		...
		if (Settings.showDebug) toast(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "m-2 flex flex-col justify-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "当前历史位置" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn(this.currentIndex === this.history.length - 1 && "text-green-500"),
						children: this.currentIndex + 1
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
	...
	*/
	get(index) {
		if (index < 0) return deserialize(import_lodash.default.cloneDeep(this.initialStage), this.project);
		return deserialize(import_lodash.default.cloneDeep(this.history[index]), this.project);
	}
	/**
	* 清空历史记录
	...
	*/
	clearHistory() {
		...
		if (Settings.showDebug) toast("历史记录已清空");
	}
};
var HistorymanagerMemoryEfficient = class extends HistoryManagerAbs {
	project;
	/**
	* 历史记录列表数组
	...
	*/
	recordStep() {
		...
		this.currentIndex++;
		const patch_ = diff(serialize(this.get(this.currentIndex - 1)), serialize(this.project.stage));
		if (!patch_) {
			this.currentIndex--;
			return;
		}
		...
		while (this.deltas.length > Settings.historySize) {
			const firstDelta = import_lodash.default.cloneDeep(this.deltas[0]);
			this.initialStage = patch(import_lodash.default.cloneDeep(this.initialStage), firstDelta);
			this.deltas.shift();
			this.currentIndex--;
		}
		if (this.currentIndex >= this.deltas.length) this.currentIndex = this.deltas.length - 1;
		this.project.projectState = ProjectState.Unsaved;
	}
	/**
	* 撤销
		...
		if (Settings.showDebug) toast(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "m-2 flex flex-col justify-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "当前历史长度" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn(this.deltas.length === Settings.historySize && "text-yellow-500"),
						children: this.deltas.length
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "m-2 flex flex-col justify-center",
	...
	*/
		...
		if (Settings.showDebug) toast(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "m-2 flex flex-col justify-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "当前历史位置" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: cn(this.currentIndex === this.deltas.length - 1 && "text-green-500"),
						children: this.currentIndex + 1
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
	...
	get(index) {
		if (index < 0) return deserialize(import_lodash.default.cloneDeep(this.initialStage), this.project);
		const deltas = import_lodash.default.cloneDeep(this.deltas.slice(0, index + 1));
		let data = import_lodash.default.cloneDeep(this.initialStage);
		for (const delta of deltas) data = patch(data, import_lodash.default.cloneDeep(delta));
		return deserialize(data, this.project);
	}
	/**
	* 清空历史记录
	* 保存文件时调用，将当前状态设为新的初始状态
...
var HistoryManager = class HistoryManager extends HistoryManagerAbs {
	project;
	memoryEfficient;
	timeEfficient;
	unwatchHistoryManagerMode;
	currentManager;
	constructor(project) {
		super();
		this.project = project;
...
HistoryManager = __decorate([service("historyManager"), __decorateMetadata("design:paramtypes", [typeof Project === "undefined" ? Object : Project])], HistoryManager);
//#endregion
export { useComposedRef as i, require_lodash as n, create as r, HistoryManager as t };
