...
import { i as createLiveProjectBuiltInToolRuntimeHost, r as classifyBuiltInToolException, s as invokeBuiltInTool } from "./BuiltInToolRegistry-DDqJSJVu.mjs";
...
import { n as require_react$1, t as require_react_dom } from "./react-dom-I8_g7zx2.mjs";
...
* See the LICENSE file in the root directory of this source tree.
*/
var LucideContext = (0, import_react$1.createContext)({});
var useLucideContext = () => (0, import_react$1.useContext)(LucideContext);
//#endregion
...
* See the LICENSE file in the root directory of this source tree.
*/
var Icon$1 = (0, import_react$1.forwardRef)(({ color, size, strokeWidth, absoluteStrokeWidth, className = "", children, iconNode, ...rest }, ref) => {
	const { size: contextSize = 24, strokeWidth: contextStrokeWidth = 2, absoluteStrokeWidth: contextAbsoluteStrokeWidth = false, color: contextColor = "currentColor", className: contextClass = "" } = useLucideContext() ?? {};
	const calculatedStrokeWidth = absoluteStrokeWidth ?? contextAbsoluteStrokeWidth ? Number(strokeWidth ?? contextStrokeWidth) * 24 / Number(size ?? contextSize) : strokeWidth ?? contextStrokeWidth;
	return (0, import_react$1.createElement)("svg", {
		ref,
		...defaultAttributes,
...
var createLucideIcon = (iconName, iconNode) => {
	const Component = (0, import_react$1.forwardRef)(({ className, ...props }, ref) => (0, import_react$1.createElement)(Icon$1, {
		ref,
		iconNode,
...
var use$2 = import_react$1[" use ".trim().toString()];
...
function createSlot$1(ownerName) {
	...
	const Slot2 = import_react$1.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		if (isLazyComponent(children) && typeof use$2 === "function") children = use$2(children._payload);
		const childrenArray = import_react$1.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$1);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
					if (import_react$1.Children.count(newElement) > 1) return import_react$1.Children.only(null);
					return import_react$1.isValidElement(newElement) ? newElement.props.children : null;
				} else return child;
			});
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlotClone, {
				...slotProps,
				ref: forwardedRef,
				children: import_react$1.isValidElement(newElement) ? import_react$1.cloneElement(newElement, void 0, newChildren) : null
			});
		}
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlotClone, {
			...slotProps,
...
function createSlotClone$1(ownerName) {
	const SlotClone = import_react$1.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		if (isLazyComponent(children) && typeof use$2 === "function") children = use$2(children._payload);
		if (import_react$1.isValidElement(children)) {
			const childrenRef = getElementRef$2(children);
			const props2 = mergeProps$1(slotProps, children.props);
			if (children.type !== import_react$1.Fragment) props2.ref = forwardedRef ? composeRefs$1(forwardedRef, childrenRef) : childrenRef;
			return import_react$1.cloneElement(children, props2);
		}
		return import_react$1.Children.count(children) > 1 ? import_react$1.Children.only(null) : null;
	});
...
function isSlottable$1(child) {
	return import_react$1.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$1;
}
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-compose-refs@1.1.2_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
function useComposedRefs(...refs) {
	return import_react$1.useCallback(composeRefs(...refs), refs);
}
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-context@1.1.2_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-context/dist/index.mjs
function createContext2(rootComponentName, defaultContext) {
	const Context = import_react$1.createContext(defaultContext);
	const Provider = (props) => {
		const { children, ...context } = props;
		const value = import_react$1.useMemo(() => context, Object.values(context));
	...
	function useContext2(consumerName) {
		const context = import_react$1.useContext(Context);
...
function createContextScope(scopeName, createContextScopeDeps = []) {
	...
	function createContext3(rootComponentName, defaultContext) {
		const BaseContext = import_react$1.createContext(defaultContext);
	...
	const createScope = () => {
		const scopeContexts = defaultContexts.map((defaultContext) => {
			return import_react$1.createContext(defaultContext);
		});
		return function useScope(scope) {
			const contexts = scope?.[scopeName] || scopeContexts;
			return import_react$1.useMemo(() => ({ [`__scope${scopeName}`]: {
				...scope,
				[scopeName]: contexts
			} }), [scope, contexts]);
		};
...
function composeContextScopes(...scopes) {
	...
	const createScope = () => {
		...
		return function useComposedScopes(overrideScopes) {
			...
			return import_react$1.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
		};
	};
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-use-layout-effect@1.1.1_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2 = globalThis?.document ? import_react$1.useLayoutEffect : () => {};
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-use-controllable-state@1.2.2_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect = import_react$1[" useInsertionEffect ".trim().toString()] || useLayoutEffect2;
function useControllableState({ prop, defaultProp, onChange = () => {}, caller }) {
	...
	{
		const isControlledRef = import_react$1.useRef(prop !== void 0);
	...
	return [value, import_react$1.useCallback((nextValue) => {
		if (isControlled) {
...
function useUncontrolledState({ defaultProp, onChange }) {
	const [value, setValue] = import_react$1.useState(defaultProp);
	const prevValueRef = import_react$1.useRef(value);
	const onChangeRef = import_react$1.useRef(onChange);
	useInsertionEffect(() => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-use-previous@1.1.1_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-use-previous/dist/index.mjs
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-use-size@1.1.1_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-use-size/dist/index.mjs
function useSize(element) {
	const [size, setSize] = import_react$1.useState(void 0);
	useLayoutEffect2(() => {
		if (element) {
			setSize({
...
function createSlotClone(ownerName) {
	const SlotClone = import_react$1.forwardRef((props, forwardedRef) => {
		...
		if (import_react$1.isValidElement(children)) {
			...
			if (children.type !== import_react$1.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react$1.cloneElement(children, props2);
		}
		return import_react$1.Children.count(children) > 1 ? import_react$1.Children.only(null) : null;
	});
...
function isSlottable(child) {
	return import_react$1.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER;
}
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-primitive@2.1.3_@types+react-dom@19.2.3_@types+react@19.2.14__@types+re_09e6e0ccf209aa4bd9af72ae117fe802/node_modules/@radix-ui/react-primitive/dist/index.mjs
var Primitive$1 = [
	"a",
	"button",
	"div",
	...
	const Node = import_react$1.forwardRef((props, forwardedRef) => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-switch@1.2.6_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react_a76824b15b11898d0912c422600b7d91/node_modules/@radix-ui/react-switch/dist/index.mjs
var SWITCH_NAME = "Switch";
var [createSwitchContext, createSwitchScope] = createContextScope(SWITCH_NAME);
var [SwitchProvider, useSwitchContext] = createSwitchContext(SWITCH_NAME);
var Switch$1 = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopeSwitch, name, checked: checkedProp, defaultChecked, required, disabled, value = "on", onCheckedChange, form, ...switchProps } = props;
	const [button, setButton] = import_react$1.useState(null);
	const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
	const hasConsumerStoppedPropagationRef = import_react$1.useRef(false);
...
var SwitchThumb = import_react$1.forwardRef((props, forwardedRef) => {
...
var SwitchBubbleInput = import_react$1.forwardRef(({ __scopeSwitch, control, checked, bubbles = true, ...props }, forwardedRef) => {
	const ref = import_react$1.useRef(null);
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-collection@1.1.7_@types+react-dom@19.2.3_@types+react@19.2.14__@types+r_4fb09693843e1dddd86a3a2e9767284a/node_modules/@radix-ui/react-collection/dist/index.mjs
function createCollection(name) {
	...
	const CollectionProvider = (props) => {
		...
		const ref = import_react$1.useRef(null);
		const itemMap = import_react$1.useRef(/* @__PURE__ */ new Map()).current;
	...
	const CollectionSlot = import_react$1.forwardRef((props, forwardedRef) => {
		const { scope, children } = props;
	...
	const CollectionItemSlot = import_react$1.forwardRef((props, forwardedRef) => {
	...
	function useCollection(scope) {
		...
		return import_react$1.useCallback(() => {
...
var useReactId = import_react$1[" useId ".trim().toString()] || (() => void 0);
var count$1 = 0;
function useId(deterministicId) {
	const [id, setId] = import_react$1.useState(useReactId());
	useLayoutEffect2(() => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-use-callback-ref@1.1.1_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-use-callback-ref/dist/index.mjs
function useCallbackRef$1(callback) {
	const callbackRef = import_react$1.useRef(callback);
	import_react$1.useEffect(() => {
		callbackRef.current = callback;
	});
	return import_react$1.useMemo(() => (...args) => callbackRef.current?.(...args), []);
}
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-direction@1.1.1_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-direction/dist/index.mjs
var DirectionContext = import_react$1.createContext(void 0);
function useDirection(localDir) {
	const globalDir = import_react$1.useContext(DirectionContext);
	return localDir || globalDir || "ltr";
}
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-roving-focus@1.1.11_@types+react-dom@19.2.3_@types+react@19.2.14__@type_9d797d2bb0e1cabb88451b302d91a28f/node_modules/@radix-ui/react-roving-focus/dist/index.mjs
...
var RovingFocusGroup = import_react$1.forwardRef((props, forwardedRef) => {
...
var RovingFocusGroupImpl = import_react$1.forwardRef((props, forwardedRef) => {
	...
	const [isTabbingBackOut, setIsTabbingBackOut] = import_react$1.useState(false);
	const handleEntryFocus = useCallbackRef$1(onEntryFocus);
	const getItems = useCollection$3(__scopeRovingFocusGroup);
	const isClickFocusRef = import_react$1.useRef(false);
	const [focusableItemsCount, setFocusableItemsCount] = import_react$1.useState(0);
	import_react$1.useEffect(() => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RovingFocusProvider, {
		...
		loop,
		currentTabStopId,
		onItemFocus: import_react$1.useCallback((tabStopId) => setCurrentTabStopId(tabStopId), [setCurrentTabStopId]),
		onItemShiftTab: import_react$1.useCallback(() => setIsTabbingBackOut(true), []),
		onFocusableItemAdd: import_react$1.useCallback(() => setFocusableItemsCount((prevCount) => prevCount + 1), []),
		onFocusableItemRemove: import_react$1.useCallback(() => setFocusableItemsCount((prevCount) => prevCount - 1), []),
...
var RovingFocusGroupItem = import_react$1.forwardRef((props, forwardedRef) => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-separator@1.1.7_@types+react-dom@19.2.3_@types+react@19.2.14__@types+re_6f7d5dfdac93a29b994219c165aeab8b/node_modules/@radix-ui/react-separator/dist/index.mjs
var NAME$4 = "Separator";
var DEFAULT_ORIENTATION$1 = "horizontal";
var ORIENTATIONS$1 = ["horizontal", "vertical"];
var Separator$3 = import_react$1.forwardRef((props, forwardedRef) => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-toggle@1.1.10_@types+react-dom@19.2.3_@types+react@19.2.14__@types+reac_dff5d789a9c4f2cb53dcdc079af5435e/node_modules/@radix-ui/react-toggle/dist/index.mjs
var NAME$3 = "Toggle";
var Toggle = import_react$1.forwardRef((props, forwardedRef) => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-toggle-group@1.1.11_@types+react-dom@19.2.3_@types+react@19.2.14__@type_67be5b56b565ffded4942ad0ff14ef83/node_modules/@radix-ui/react-toggle-group/dist/index.mjs
...
var ToggleGroup = import_react$1.forwardRef((props, forwardedRef) => {
...
var ToggleGroupImplSingle = import_react$1.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleGroupValueProvider, {
		...
		type: "single",
		value: import_react$1.useMemo(() => value ? [value] : [], [value]),
		onItemActivate: setValue,
		onItemDeactivate: import_react$1.useCallback(() => setValue(""), [setValue]),
...
var ToggleGroupImplMultiple = import_react$1.forwardRef((props, forwardedRef) => {
	...
	const handleButtonActivate = import_react$1.useCallback((itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]), [setValue]);
	const handleButtonDeactivate = import_react$1.useCallback((itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)), [setValue]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleGroupValueProvider, {
		scope: props.__scopeToggleGroup,
		type: "multiple",
		value,
...
var ToggleGroupImpl = import_react$1.forwardRef((props, forwardedRef) => {
...
var ToggleGroupItem = import_react$1.forwardRef((props, forwardedRef) => {
...
var ToggleGroupItemImpl = import_react$1.forwardRef((props, forwardedRef) => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-toolbar@1.1.11_@types+react-dom@19.2.3_@types+react@19.2.14__@types+rea_d4f9c261e7f8b095e6f1a9ba884f01a3/node_modules/@radix-ui/react-toolbar/dist/index.mjs
...
var Toolbar$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var ToolbarSeparator = import_react$1.forwardRef((props, forwardedRef) => {
...
var ToolbarButton$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var ToolbarLink = import_react$1.forwardRef((props, forwardedRef) => {
...
var ToolbarToggleGroup$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var ToolbarToggleItem$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-use-escape-keydown@1.1.1_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-use-escape-keydown/dist/index.mjs
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-dismissable-layer@1.1.11_@types+react-dom@19.2.3_@types+react@19.2.14___79ac7923fbbaa70dde2128695a66e4d1/node_modules/@radix-ui/react-dismissable-layer/dist/index.mjs
var DISMISSABLE_LAYER_NAME = "DismissableLayer";
var CONTEXT_UPDATE = "dismissableLayer.update";
var POINTER_DOWN_OUTSIDE = "dismissableLayer.pointerDownOutside";
var FOCUS_OUTSIDE = "dismissableLayer.focusOutside";
var originalBodyPointerEvents;
var DismissableLayerContext = import_react$1.createContext({
	layers: /* @__PURE__ */ new Set(),
	layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
	branches: /* @__PURE__ */ new Set()
});
var DismissableLayer = import_react$1.forwardRef((props, forwardedRef) => {
	const { disableOutsidePointerEvents = false, onEscapeKeyDown, onPointerDownOutside, onFocusOutside, onInteractOutside, onDismiss, ...layerProps } = props;
	const context = import_react$1.useContext(DismissableLayerContext);
	const [node, setNode] = import_react$1.useState(null);
	const ownerDocument = node?.ownerDocument ?? globalThis?.document;
	const [, force] = import_react$1.useState({});
...
var DismissableLayerBranch = import_react$1.forwardRef((props, forwardedRef) => {
	const context = import_react$1.useContext(DismissableLayerContext);
	const ref = import_react$1.useRef(null);
	const composedRefs = useComposedRefs(forwardedRef, ref);
	import_react$1.useEffect(() => {
...
function usePointerDownOutside(onPointerDownOutside, ownerDocument = globalThis?.document) {
	...
	const isPointerInsideReactTreeRef = import_react$1.useRef(false);
	const handleClickRef = import_react$1.useRef(() => {});
	import_react$1.useEffect(() => {
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
	...
	const isFocusInsideReactTreeRef = import_react$1.useRef(false);
	import_react$1.useEffect(() => {
...
//#endregion
//#region ../node_modules/.pnpm/@floating-ui+react-dom@2.1.8_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/@floating-ui/react-dom/dist/floating-ui.react-dom.mjs
var index = typeof document !== "undefined" ? import_react$1.useLayoutEffect : function noop() {};
...
function useLatestRef(value) {
	const ref = import_react$1.useRef(value);
	index(() => {
		ref.current = value;
	});
	return ref;
...
function useFloating(options) {
	...
	const [data, setData] = import_react$1.useState({
		x: 0,
		y: 0,
		strategy,
		placement,
	...
	const [latestMiddleware, setLatestMiddleware] = import_react$1.useState(middleware);
	if (!deepEqual(latestMiddleware, middleware)) setLatestMiddleware(middleware);
	const [_reference, _setReference] = import_react$1.useState(null);
	const [_floating, _setFloating] = import_react$1.useState(null);
	...
	const setFloating = import_react$1.useCallback((node) => {
	...
	const referenceRef = import_react$1.useRef(null);
	const floatingRef = import_react$1.useRef(null);
	const dataRef = import_react$1.useRef(data);
	const hasWhileElementsMounted = whileElementsMounted != null;
	const whileElementsMountedRef = useLatestRef(whileElementsMounted);
	const platformRef = useLatestRef(platform);
	const openRef = useLatestRef(open);
	const update = import_react$1.useCallback(() => {
	...
	const isMountedRef = import_react$1.useRef(false);
	index(() => {
	...
	const floatingStyles = import_react$1.useMemo(() => {
		const initialStyles = {
			position: strategy,
			left: 0,
			top: 0
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-arrow@1.1.7_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react@_d62890c567682a598b3e026b4a1be435/node_modules/@radix-ui/react-arrow/dist/index.mjs
var NAME$2 = "Arrow";
var Arrow$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var Root$4 = Arrow$1;
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-popper@1.2.8_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react_8fba32ba52522a8383d9c6e1d4587da6/node_modules/@radix-ui/react-popper/dist/index.mjs
var POPPER_NAME = "Popper";
var [createPopperContext, createPopperScope] = createContextScope(POPPER_NAME);
var [PopperProvider, usePopperContext] = createPopperContext(POPPER_NAME);
var Popper = (props) => {
	const { __scopePopper, children } = props;
	const [anchor, setAnchor] = import_react$1.useState(null);
...
var PopperAnchor = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopePopper, virtualRef, ...anchorProps } = props;
	const context = usePopperContext(ANCHOR_NAME$1, __scopePopper);
	const ref = import_react$1.useRef(null);
	const composedRefs = useComposedRefs(forwardedRef, ref);
	const anchorRef = import_react$1.useRef(null);
	import_react$1.useEffect(() => {
...
var PopperContent = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopePopper, side = "bottom", sideOffset = 0, align = "center", alignOffset = 0, arrowPadding = 0, avoidCollisions = true, collisionBoundary = [], collisionPadding: collisionPaddingProp = 0, sticky = "partial", hideWhenDetached = false, updatePositionStrategy = "optimized", onPlaced, ...contentProps } = props;
	const context = usePopperContext(CONTENT_NAME$5, __scopePopper);
	const [content, setContent] = import_react$1.useState(null);
	const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
	const [arrow$4, setArrow] = import_react$1.useState(null);
	...
	const [contentZIndex, setContentZIndex] = import_react$1.useState();
	useLayoutEffect2(() => {
...
var PopperArrow = import_react$1.forwardRef(function PopperArrow2(props, forwardedRef) {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-portal@1.1.9_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react_92e223af8b4a901db213297dcfb30a72/node_modules/@radix-ui/react-portal/dist/index.mjs
var PORTAL_NAME$5 = "Portal";
var Portal$4 = import_react$1.forwardRef((props, forwardedRef) => {
	const { container: containerProp, ...portalProps } = props;
	const [mounted, setMounted] = import_react$1.useState(false);
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-presence@1.1.5_@types+react-dom@19.2.3_@types+react@19.2.14__@types+rea_b0fb3a84d7d9ee8e6a4b5e4cb53ac68e/node_modules/@radix-ui/react-presence/dist/index.mjs
function useStateMachine(initialState, machine) {
	return import_react$1.useReducer((state, event) => {
...
var Presence = (props) => {
	...
	const child = typeof children === "function" ? children({ present: presence.isPresent }) : import_react$1.Children.only(children);
	const ref = useComposedRefs(presence.ref, getElementRef(child));
	return typeof children === "function" || presence.isPresent ? import_react$1.cloneElement(child, { ref }) : null;
};
Presence.displayName = "Presence";
function usePresence(present) {
	const [node, setNode] = import_react$1.useState();
	const stylesRef = import_react$1.useRef(null);
	const prevPresentRef = import_react$1.useRef(present);
	const prevAnimationNameRef = import_react$1.useRef("none");
	...
	return {
		...
		ref: import_react$1.useCallback((node2) => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-visually-hidden@1.2.3_@types+react-dom@19.2.3_@types+react@19.2.14__@ty_e259c0452f588d18e39ec76b2bae3d97/node_modules/@radix-ui/react-visually-hidden/dist/index.mjs
...
var VisuallyHidden = import_react$1.forwardRef((props, forwardedRef) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$1.span, {
		...props,
		ref: forwardedRef,
		style: {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-tooltip@1.2.8_@types+react-dom@19.2.3_@types+react@19.2.14__@types+reac_c11abd87b741576dd78c968e2f900814/node_modules/@radix-ui/react-tooltip/dist/index.mjs
...
var TooltipProvider$1 = (props) => {
	...
	const isOpenDelayedRef = import_react$1.useRef(true);
	const isPointerInTransitRef = import_react$1.useRef(false);
	const skipDelayTimerRef = import_react$1.useRef(0);
	import_react$1.useEffect(() => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipProviderContextProvider, {
		...
		isOpenDelayedRef,
		delayDuration,
		onOpen: import_react$1.useCallback(() => {
			window.clearTimeout(skipDelayTimerRef.current);
			isOpenDelayedRef.current = false;
		}, []),
		onClose: import_react$1.useCallback(() => {
			window.clearTimeout(skipDelayTimerRef.current);
			skipDelayTimerRef.current = window.setTimeout(() => isOpenDelayedRef.current = true, skipDelayDuration);
		}, [skipDelayDuration]),
		isPointerInTransitRef,
		onPointerInTransitChange: import_react$1.useCallback((inTransit) => {
...
var Tooltip$1 = (props) => {
	...
	const [trigger, setTrigger] = import_react$1.useState(null);
	const contentId = useId();
	const openTimerRef = import_react$1.useRef(0);
	const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
	const delayDuration = delayDurationProp ?? providerContext.delayDuration;
	const wasOpenDelayedRef = import_react$1.useRef(false);
	...
	const stateAttribute = import_react$1.useMemo(() => {
		return open ? wasOpenDelayedRef.current ? "delayed-open" : "instant-open" : "closed";
	}, [open]);
	const handleOpen = import_react$1.useCallback(() => {
		window.clearTimeout(openTimerRef.current);
		openTimerRef.current = 0;
		wasOpenDelayedRef.current = false;
		setOpen(true);
	}, [setOpen]);
	const handleClose = import_react$1.useCallback(() => {
		window.clearTimeout(openTimerRef.current);
		openTimerRef.current = 0;
		setOpen(false);
	}, [setOpen]);
	const handleDelayedOpen = import_react$1.useCallback(() => {
		window.clearTimeout(openTimerRef.current);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root2$2, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContextProvider, {
			...
			onTriggerEnter: import_react$1.useCallback(() => {
			...
			onTriggerLeave: import_react$1.useCallback(() => {
...
var TooltipTrigger$1 = import_react$1.forwardRef((props, forwardedRef) => {
	...
	const popperScope = usePopperScope$2(__scopeTooltip);
	const composedRefs = useComposedRefs(forwardedRef, import_react$1.useRef(null), context.onTriggerChange);
	const isPointerDownRef = import_react$1.useRef(false);
	const hasPointerMoveOpenedRef = import_react$1.useRef(false);
	const handlePointerUp = import_react$1.useCallback(() => isPointerDownRef.current = false, []);
	import_react$1.useEffect(() => {
...
var TooltipContent$2 = import_react$1.forwardRef((props, forwardedRef) => {
...
var TooltipContentHoverable = import_react$1.forwardRef((props, forwardedRef) => {
	const context = useTooltipContext(CONTENT_NAME$4, props.__scopeTooltip);
	const providerContext = useTooltipProviderContext(CONTENT_NAME$4, props.__scopeTooltip);
	const ref = import_react$1.useRef(null);
	const composedRefs = useComposedRefs(forwardedRef, ref);
	const [pointerGraceArea, setPointerGraceArea] = import_react$1.useState(null);
	const { trigger, onClose } = context;
	const content = ref.current;
	const { onPointerInTransitChange } = providerContext;
	const handleRemoveGraceArea = import_react$1.useCallback(() => {
		setPointerGraceArea(null);
		onPointerInTransitChange(false);
	}, [onPointerInTransitChange]);
	const handleCreateGraceArea = import_react$1.useCallback((event, hoverTarget) => {
...
var TooltipContentImpl = import_react$1.forwardRef((props, forwardedRef) => {
...
var TooltipArrow = import_react$1.forwardRef((props, forwardedRef) => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-focus-guards@1.1.3_@types+react@19.2.14_react@19.2.7/node_modules/@radix-ui/react-focus-guards/dist/index.mjs
var count = 0;
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-focus-scope@1.1.7_@types+react-dom@19.2.3_@types+react@19.2.14__@types+_07eb8840b0faf9d9959e59dd270a4cf7/node_modules/@radix-ui/react-focus-scope/dist/index.mjs
...
var FocusScope = import_react$1.forwardRef((props, forwardedRef) => {
	const { loop = false, trapped = false, onMountAutoFocus: onMountAutoFocusProp, onUnmountAutoFocus: onUnmountAutoFocusProp, ...scopeProps } = props;
	const [container, setContainer] = import_react$1.useState(null);
	const onMountAutoFocus = useCallbackRef$1(onMountAutoFocusProp);
	const onUnmountAutoFocus = useCallbackRef$1(onUnmountAutoFocusProp);
	const lastFocusedElementRef = import_react$1.useRef(null);
	const composedRefs = useComposedRefs(forwardedRef, (node) => setContainer(node));
	const focusScope = import_react$1.useRef({
		paused: false,
		pause() {
			this.paused = true;
		},
	...
	const handleKeyDown = import_react$1.useCallback((event) => {
...
//#endregion
//#region ../node_modules/.pnpm/react-remove-scroll-bar@2.3.8_@types+react@19.2.14_react@19.2.7/node_modules/react-remove-scroll-bar/dist/es2015/constants.js
...
function useCallbackRef(initialValue, callback) {
	var ref = (0, import_react$1.useState)(function() {
		return {
			value: initialValue,
			callback,
			facade: {
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react$1.useLayoutEffect : import_react$1.useEffect;
...
var SideCar = function(_a) {
	...
	return import_react$1.createElement(Target, __assign({}, rest));
};
...
*/
var RemoveScroll = import_react$1.forwardRef(function(props, parentRef) {
	var ref = import_react$1.useRef(null);
	var _a = import_react$1.useState({
	...
	return import_react$1.createElement(import_react$1.Fragment, null, enabled && import_react$1.createElement(SideCar, {
		sideCar: effectCar,
		removeScrollBar,
		shards,
		noRelative,
		...
		lockRef: ref,
		gapMode
	}), forwardProps ? import_react$1.cloneElement(import_react$1.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef })) : import_react$1.createElement(Container, __assign({}, containerProps, {
		className,
		ref: containerRef
	}), children));
});
...
//#endregion
//#region ../node_modules/.pnpm/react-style-singleton@2.2.3_@types+react@19.2.14_react@19.2.7/node_modules/react-style-singleton/dist/es2015/singleton.js
...
//#endregion
//#region ../node_modules/.pnpm/react-style-singleton@2.2.3_@types+react@19.2.14_react@19.2.7/node_modules/react-style-singleton/dist/es2015/hook.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/react-style-singleton@2.2.3_@types+react@19.2.14_react@19.2.7/node_modules/react-style-singleton/dist/es2015/component.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/react-remove-scroll-bar@2.3.8_@types+react@19.2.14_react@19.2.7/node_modules/react-remove-scroll-bar/dist/es2015/utils.js
var zeroGap = {
	left: 0,
	top: 0,
	right: 0,
...
//#endregion
//#region ../node_modules/.pnpm/react-remove-scroll-bar@2.3.8_@types+react@19.2.14_react@19.2.7/node_modules/react-remove-scroll-bar/dist/es2015/component.js
...
var RemoveScrollBar = function(_a) {
	...
	useLockAttribute();
	var gap = import_react$1.useMemo(function() {
		return getGapWidth(gapMode);
	}, [gapMode]);
	return import_react$1.createElement(Style, { styles: getStyles(gap, !noRelative, gapMode, !noImportant ? "!important" : "") });
};
//#endregion
...
function RemoveScrollSideCar(props) {
	var shouldPreventQueue = import_react$1.useRef([]);
	var touchStartRef = import_react$1.useRef([0, 0]);
	var activeAxis = import_react$1.useRef();
	var id = import_react$1.useState(idCounter++)[0];
	var Style = import_react$1.useState(styleSingleton)[0];
	var lastProps = import_react$1.useRef(props);
	import_react$1.useEffect(function() {
	...
	var shouldCancelEvent = import_react$1.useCallback(function(event, parent) {
	...
	var shouldPrevent = import_react$1.useCallback(function(_event) {
		var event = _event;
	...
	var shouldCancel = import_react$1.useCallback(function(name, delta, target, should) {
		var event = {
			name,
			delta,
			target,
	...
	var scrollTouchStart = import_react$1.useCallback(function(event) {
		touchStartRef.current = getTouchXY(event);
		activeAxis.current = void 0;
	}, []);
	var scrollWheel = import_react$1.useCallback(function(event) {
		shouldCancel(event.type, getDeltaXY(event), event.target, shouldCancelEvent(event, props.lockRef.current));
	}, []);
	var scrollTouchMove = import_react$1.useCallback(function(event) {
	...
	return import_react$1.createElement(import_react$1.Fragment, null, inert ? import_react$1.createElement(Style, { styles: generateStyle(id) }) : null, removeScrollBar ? import_react$1.createElement(RemoveScrollBar, {
...
var ReactRemoveScroll = import_react$1.forwardRef(function(props, ref) {
	return import_react$1.createElement(RemoveScroll, __assign({}, props, {
		ref,
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-menu@2.1.16_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react@_d69fe6d7c13da483b04d9ee39f060823/node_modules/@radix-ui/react-menu/dist/index.mjs
...
var Menu = (props) => {
	...
	const [content, setContent] = import_react$1.useState(null);
	const isUsingKeyboardRef = import_react$1.useRef(false);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root2$2, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuProvider, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuRootProvider, {
				scope: __scopeMenu,
				onClose: import_react$1.useCallback(() => handleOpenChange(false), [handleOpenChange]),
				isUsingKeyboardRef,
				dir: direction,
				modal,
				children
...
var MenuAnchor = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuContent = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuRootContentModal = import_react$1.forwardRef((props, forwardedRef) => {
	const context = useMenuContext(CONTENT_NAME$3, props.__scopeMenu);
	const ref = import_react$1.useRef(null);
	const composedRefs = useComposedRefs(forwardedRef, ref);
	import_react$1.useEffect(() => {
...
var MenuRootContentNonModal = import_react$1.forwardRef((props, forwardedRef) => {
	const context = useMenuContext(CONTENT_NAME$3, props.__scopeMenu);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuContentImpl, {
		...props,
		ref: forwardedRef,
...
var MenuContentImpl = import_react$1.forwardRef((props, forwardedRef) => {
	...
	const [currentItemId, setCurrentItemId] = import_react$1.useState(null);
	const contentRef = import_react$1.useRef(null);
	const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
	const timerRef = import_react$1.useRef(0);
	const searchRef = import_react$1.useRef("");
	const pointerGraceTimerRef = import_react$1.useRef(0);
	const pointerGraceIntentRef = import_react$1.useRef(null);
	const pointerDirRef = import_react$1.useRef("right");
	const lastPointerXRef = import_react$1.useRef(0);
	const ScrollLockWrapper = disableOutsideScroll ? ReactRemoveScroll : import_react$1.Fragment;
	...
	useFocusGuards();
	const isPointerMovingToSubmenu = import_react$1.useCallback((event) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuContentProvider, {
		scope: __scopeMenu,
		searchRef,
		onItemEnter: import_react$1.useCallback((event) => {
			if (isPointerMovingToSubmenu(event)) event.preventDefault();
		}, [isPointerMovingToSubmenu]),
		onItemLeave: import_react$1.useCallback((event) => {
			if (isPointerMovingToSubmenu(event)) return;
			contentRef.current?.focus();
			setCurrentItemId(null);
		}, [isPointerMovingToSubmenu]),
		onTriggerLeave: import_react$1.useCallback((event) => {
			if (isPointerMovingToSubmenu(event)) event.preventDefault();
		}, [isPointerMovingToSubmenu]),
		pointerGraceTimerRef,
		onPointerGraceIntentChange: import_react$1.useCallback((intent) => {
...
var MenuGroup = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuLabel = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuItem = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuItemImpl = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopeMenu, disabled = false, textValue, ...itemProps } = props;
	const contentContext = useMenuContentContext(ITEM_NAME$2, __scopeMenu);
	const rovingFocusGroupScope = useRovingFocusGroupScope(__scopeMenu);
	const ref = import_react$1.useRef(null);
	const composedRefs = useComposedRefs(forwardedRef, ref);
	const [isFocused, setIsFocused] = import_react$1.useState(false);
	const [textContent, setTextContent] = import_react$1.useState("");
	import_react$1.useEffect(() => {
		const menuItem = ref.current;
...
var MenuCheckboxItem = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuRadioGroup = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuRadioItem = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuItemIndicator = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuSeparator = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuArrow = import_react$1.forwardRef((props, forwardedRef) => {
...
var MenuSubTrigger = import_react$1.forwardRef((props, forwardedRef) => {
	const context = useMenuContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
	const rootContext = useMenuRootContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
	const subContext = useMenuSubContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
	const contentContext = useMenuContentContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
	const openTimerRef = import_react$1.useRef(null);
	const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
	const scope = { __scopeMenu: props.__scopeMenu };
	const clearOpenTimer = import_react$1.useCallback(() => {
		if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
		openTimerRef.current = null;
	}, []);
	import_react$1.useEffect(() => clearOpenTimer, [clearOpenTimer]);
	import_react$1.useEffect(() => {
...
var MenuSubContent = import_react$1.forwardRef((props, forwardedRef) => {
	const portalContext = usePortalContext$1(CONTENT_NAME$3, props.__scopeMenu);
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-dropdown-menu@2.1.16_@types+react-dom@19.2.3_@types+react@19.2.14__@typ_6cd9b771d1286a070fa3179e8cb914be/node_modules/@radix-ui/react-dropdown-menu/dist/index.mjs
...
var DropdownMenu$1 = (props) => {
	...
	const triggerRef = import_react$1.useRef(null);
	const [open, setOpen] = useControllableState({
		prop: openProp,
		defaultProp: defaultOpen ?? false,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuProvider, {
		...
		onOpenToggle: import_react$1.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
		modal,
...
var DropdownMenuTrigger$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuContent$1 = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopeDropdownMenu, ...contentProps } = props;
	const context = useDropdownMenuContext(CONTENT_NAME$2, __scopeDropdownMenu);
	const menuScope = useMenuScope(__scopeDropdownMenu);
	const hasInteractedOutsideRef = import_react$1.useRef(false);
...
var DropdownMenuGroup$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuLabel$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItem$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuCheckboxItem$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubTrigger$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var Separator$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
function TooltipContent$1({ className, sideOffset = 24, children, ...props }) {
	const contentRef = import_react$1.useRef(null);
	const [offset, setOffset] = import_react$1.useState({
		left: 0,
		top: 0
	});
	import_react$1.useEffect(() => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-dialog@1.1.15_@types+react-dom@19.2.3_@types+react@19.2.14__@types+reac_397f5e87696b226e9b39529c4b058b0d/node_modules/@radix-ui/react-dialog/dist/index.mjs
...
var DialogTrigger = import_react$1.forwardRef((props, forwardedRef) => {
...
var DialogPortal$1 = (props) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PortalProvider, {
		scope: __scopeDialog,
		forceMount,
		children: import_react$1.Children.map(children, (child) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
			present: forceMount || context.open,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal$4, {
				asChild: true,
				container,
...
var DialogOverlay$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DialogOverlayImpl = import_react$1.forwardRef((props, forwardedRef) => {
...
var DialogContent$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DialogContentModal = import_react$1.forwardRef((props, forwardedRef) => {
	const context = useDialogContext(CONTENT_NAME$1, props.__scopeDialog);
	const contentRef = import_react$1.useRef(null);
...
var DialogContentNonModal = import_react$1.forwardRef((props, forwardedRef) => {
	const context = useDialogContext(CONTENT_NAME$1, props.__scopeDialog);
	const hasInteractedOutsideRef = import_react$1.useRef(false);
	const hasPointerDownOutsideRef = import_react$1.useRef(false);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentImpl, {
		...props,
		ref: forwardedRef,
		trapFocus: false,
...
var DialogContentImpl = import_react$1.forwardRef((props, forwardedRef) => {
...
var DialogTitle$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DialogDescription$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var DialogClose$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var Tab = class extends import_react$1.Component {
...
var ComponentTabContext = import_react$1.createContext(void 0);
//#endregion
...
var StoreContext = (0, import_react$1.createContext)(void 0);
function useStore(options) {
	const store = (0, import_react$1.useContext)(StoreContext);
...
var use$1 = import_react$1.use || ((promise) => {
...
function useAtomValue(atom, options) {
	const { delay, unstable_promiseStatus: promiseStatus = !import_react$1.use } = options || {};
	const store = useStore(options);
	const [[valueFromReducer, storeFromReducer, atomFromReducer], rerender] = (0, import_react$1.useReducer)((prev) => {
...
`);
	...
	(0, import_react$1.useDebugValue)(value);
...
function useSetAtom(atom, options) {
	const store = useStore(options);
	return (0, import_react$1.useCallback)((...args) => {
...
Dialog.confirm = (title = "你确定？", description = "", { destructive = false } = {}) => {
	return new Promise((resolve) => {
		function Component({ overlayId }) {
			const [open, setOpen] = import_react$1.useState(true);
...
Dialog.input = (title = "请输入文本", description = "", { defaultValue = "", placeholder = "...", destructive = false, multiline = false } = {}) => {
	return new Promise((resolve) => {
		function Component({ overlayId }) {
			const [open, setOpen] = import_react$1.useState(true);
			const [value, setValue] = import_react$1.useState(defaultValue);
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				open,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContent, {
					showCloseButton: false,
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-select@2.2.6_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react_96fd28d0ecd291ba74019e1d2a4857c5/node_modules/@radix-ui/react-select/dist/index.mjs
var OPEN_KEYS = [
	" ",
	"Enter",
	"ArrowUp",
...
var Select$1 = (props) => {
	...
	const [trigger, setTrigger] = import_react$1.useState(null);
	const [valueNode, setValueNode] = import_react$1.useState(null);
	const [valueNodeHasChildren, setValueNodeHasChildren] = import_react$1.useState(false);
	const direction = useDirection(dir);
	const [open, setOpen] = useControllableState({
		prop: openProp,
		defaultProp: defaultOpen ?? false,
	...
	const triggerPointerDownPosRef = import_react$1.useRef(null);
	const isFormControl = trigger ? form || !!trigger.closest("form") : true;
	const [nativeOptionsSet, setNativeOptionsSet] = import_react$1.useState(/* @__PURE__ */ new Set());
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectProvider, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$1.Provider, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectNativeOptionsProvider, {
					...
					onNativeOptionAdd: import_react$1.useCallback((option) => {
						setNativeOptionsSet((prev) => new Set(prev).add(option));
					}, []),
					onNativeOptionRemove: import_react$1.useCallback((option) => {
...
var SelectTrigger$1 = import_react$1.forwardRef((props, forwardedRef) => {
	...
	const pointerTypeRef = import_react$1.useRef("touch");
...
var SelectValue$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var SelectIcon = import_react$1.forwardRef((props, forwardedRef) => {
...
var SelectContent$1 = import_react$1.forwardRef((props, forwardedRef) => {
	const context = useSelectContext(CONTENT_NAME, props.__scopeSelect);
	const [fragment, setFragment] = import_react$1.useState();
	useLayoutEffect2(() => {
...
var SelectContentImpl = import_react$1.forwardRef((props, forwardedRef) => {
	...
	const [content, setContent] = import_react$1.useState(null);
	const [viewport, setViewport] = import_react$1.useState(null);
	const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
	const [selectedItem, setSelectedItem] = import_react$1.useState(null);
	const [selectedItemText, setSelectedItemText] = import_react$1.useState(null);
	const getItems = useCollection$1(__scopeSelect);
	const [isPositioned, setIsPositioned] = import_react$1.useState(false);
	const firstValidItemFoundRef = import_react$1.useRef(false);
	import_react$1.useEffect(() => {
		if (content) return hideOthers(content);
	}, [content]);
	useFocusGuards();
	const focusFirst = import_react$1.useCallback((candidates) => {
	...
	const focusSelectedItem = import_react$1.useCallback(() => focusFirst([selectedItem, content]), [
		focusFirst,
		selectedItem,
		content
	]);
	...
	const itemRefCallback = import_react$1.useCallback((node, value, disabled) => {
	...
	const handleItemLeave = import_react$1.useCallback(() => content?.focus(), [content]);
	const itemTextRefCallback = import_react$1.useCallback((node, value, disabled) => {
		const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
...
var SelectItemAlignedPosition = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopeSelect, onPlaced, ...popperProps } = props;
	const context = useSelectContext(CONTENT_NAME, __scopeSelect);
	const contentContext = useSelectContentContext(CONTENT_NAME, __scopeSelect);
	const [contentWrapper, setContentWrapper] = import_react$1.useState(null);
	const [content, setContent] = import_react$1.useState(null);
	const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
	const getItems = useCollection$1(__scopeSelect);
	const shouldExpandOnScrollRef = import_react$1.useRef(false);
	const shouldRepositionRef = import_react$1.useRef(true);
	const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
	const position = import_react$1.useCallback(() => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectViewportProvider, {
		...
		onScrollButtonChange: import_react$1.useCallback((node) => {
...
var SelectPopperPosition = import_react$1.forwardRef((props, forwardedRef) => {
...
var SelectViewport = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopeSelect, nonce, ...viewportProps } = props;
	const contentContext = useSelectContentContext(VIEWPORT_NAME, __scopeSelect);
	const viewportContext = useSelectViewportContext(VIEWPORT_NAME, __scopeSelect);
	const composedRefs = useComposedRefs(forwardedRef, contentContext.onViewportChange);
	const prevScrollTopRef = import_react$1.useRef(0);
...
var SelectGroup$1 = import_react$1.forwardRef((props, forwardedRef) => {
...
var SelectLabel = import_react$1.forwardRef((props, forwardedRef) => {
...
var SelectItem$1 = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopeSelect, value, disabled = false, textValue: textValueProp, ...itemProps } = props;
	const context = useSelectContext(ITEM_NAME, __scopeSelect);
	const contentContext = useSelectContentContext(ITEM_NAME, __scopeSelect);
	const isSelected = context.value === value;
	const [textValue, setTextValue] = import_react$1.useState(textValueProp ?? "");
	const [isFocused, setIsFocused] = import_react$1.useState(false);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItemContextProvider, {
		...
		textId,
		isSelected,
		onItemTextChange: import_react$1.useCallback((node) => {
...
var SelectItemText = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopeSelect, className, style, ...itemTextProps } = props;
	const context = useSelectContext(ITEM_TEXT_NAME, __scopeSelect);
	const contentContext = useSelectContentContext(ITEM_TEXT_NAME, __scopeSelect);
	const itemContext = useSelectItemContext(ITEM_TEXT_NAME, __scopeSelect);
	const nativeOptionsContext = useSelectNativeOptionsContext(ITEM_TEXT_NAME, __scopeSelect);
	const [itemTextNode, setItemTextNode] = import_react$1.useState(null);
	...
	const nativeOption = import_react$1.useMemo(() => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
...
var SelectItemIndicator = import_react$1.forwardRef((props, forwardedRef) => {
...
var SelectScrollUpButton$1 = import_react$1.forwardRef((props, forwardedRef) => {
	const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
	const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
	const [canScrollUp, setCanScrollUp] = import_react$1.useState(false);
...
var SelectScrollDownButton$1 = import_react$1.forwardRef((props, forwardedRef) => {
	const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
	const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
	const [canScrollDown, setCanScrollDown] = import_react$1.useState(false);
	const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
	useLayoutEffect2(() => {
		if (contentContext.viewport && contentContext.isPositioned) {
			let handleScroll2 = function() {
...
var SelectScrollButtonImpl = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
	const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
	const autoScrollTimerRef = import_react$1.useRef(null);
	const getItems = useCollection$1(__scopeSelect);
	const clearAutoScrollTimer = import_react$1.useCallback(() => {
...
var SelectSeparator = import_react$1.forwardRef((props, forwardedRef) => {
...
var SelectArrow = import_react$1.forwardRef((props, forwardedRef) => {
...
var SelectBubbleInput = import_react$1.forwardRef(({ __scopeSelect, value, ...props }, forwardedRef) => {
	const ref = import_react$1.useRef(null);
	const composedRefs = useComposedRefs(forwardedRef, ref);
...
function useTypeaheadSearch(onSearchChange) {
	...
	const searchRef = import_react$1.useRef("");
	const timerRef = import_react$1.useRef(0);
	const handleTypeaheadSearch = import_react$1.useCallback((key) => {
		const search = searchRef.current + key;
	...
	const resetTypeahead = import_react$1.useCallback(() => {
		searchRef.current = "";
		window.clearTimeout(timerRef.current);
	}, []);
	import_react$1.useEffect(() => {
...
//#endregion
//#region ../node_modules/.pnpm/@radix-ui+react-slider@1.3.6_@types+react-dom@19.2.3_@types+react@19.2.14__@types+react_d75abfc68867073f4a4486ead5a2f669/node_modules/@radix-ui/react-slider/dist/index.mjs
...
var Slider$1 = import_react$1.forwardRef((props, forwardedRef) => {
	...
	const thumbRefs = import_react$1.useRef(/* @__PURE__ */ new Set());
	const valueIndexToChangeRef = import_react$1.useRef(0);
	...
	const valuesBeforeSlideStartRef = import_react$1.useRef(values);
...
var SliderHorizontal = import_react$1.forwardRef((props, forwardedRef) => {
	const { min, max, dir, inverted, onSlideStart, onSlideMove, onSlideEnd, onStepKeyDown, ...sliderProps } = props;
	const [slider, setSlider] = import_react$1.useState(null);
	const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
	const rectRef = import_react$1.useRef(void 0);
	const direction = useDirection(dir);
...
var SliderVertical = import_react$1.forwardRef((props, forwardedRef) => {
	const { min, max, inverted, onSlideStart, onSlideMove, onSlideEnd, onStepKeyDown, ...sliderProps } = props;
	const sliderRef = import_react$1.useRef(null);
...
var SliderImpl = import_react$1.forwardRef((props, forwardedRef) => {
...
var SliderTrack = import_react$1.forwardRef((props, forwardedRef) => {
...
var SliderRange = import_react$1.forwardRef((props, forwardedRef) => {
	const { __scopeSlider, ...rangeProps } = props;
	const context = useSliderContext(RANGE_NAME, __scopeSlider);
	const orientation = useSliderOrientationContext(RANGE_NAME, __scopeSlider);
	const composedRefs = useComposedRefs(forwardedRef, import_react$1.useRef(null));
...
var SliderThumb = import_react$1.forwardRef((props, forwardedRef) => {
	const getItems = useCollection(props.__scopeSlider);
	const [thumb, setThumb] = import_react$1.useState(null);
	const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
	const index = import_react$1.useMemo(() => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1, [getItems, thumb]);
...
var SliderThumbImpl = import_react$1.forwardRef((props, forwardedRef) => {
...
var SliderBubbleInput = import_react$1.forwardRef(({ __scopeSlider, value, ...props }, forwardedRef) => {
	const ref = import_react$1.useRef(null);
	const composedRefs = useComposedRefs(ref, forwardedRef);
	const prevValue = usePrevious(value);
	import_react$1.useEffect(() => {
...
function Slider({ className, defaultValue, value, min = 0, max = 100, ...props }) {
	const _values = import_react$1.useMemo(() => Array.isArray(value) ? value : Array.isArray(defaultValue) ? defaultValue : [min, max], [
		value,
		defaultValue,
		min,
		max
...
//#endregion
//#region ../node_modules/.pnpm/react-i18next@17.0.6_i18next@26.0.8_typescript@5.9.2__react-dom@19.2.7_react@19.2.7__react@19.2.7_typescript@5.9.2/node_modules/react-i18next/dist/es/utils.js
...
//#endregion
//#region ../node_modules/.pnpm/react-i18next@17.0.6_i18next@26.0.8_typescript@5.9.2__react-dom@19.2.7_react@19.2.7__react@19.2.7_typescript@5.9.2/node_modules/react-i18next/dist/es/unescape.js
...
//#endregion
//#region ../node_modules/.pnpm/react-i18next@17.0.6_i18next@26.0.8_typescript@5.9.2__react-dom@19.2.7_react@19.2.7__react@19.2.7_typescript@5.9.2/node_modules/react-i18next/dist/es/defaults.js
var defaultOptions = {
...
//#endregion
//#region ../node_modules/.pnpm/react-i18next@17.0.6_i18next@26.0.8_typescript@5.9.2__react-dom@19.2.7_react@19.2.7__react@19.2.7_typescript@5.9.2/node_modules/react-i18next/dist/es/i18nInstance.js
var i18nInstance;
var getI18n = () => i18nInstance;
//#endregion
//#region ../node_modules/.pnpm/react-i18next@17.0.6_i18next@26.0.8_typescript@5.9.2__react-dom@19.2.7_react@19.2.7__react@19.2.7_typescript@5.9.2/node_modules/react-i18next/dist/es/context.js
var I18nContext = (0, import_react$1.createContext)();
...
var require_use_sync_external_store_shim_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	"production" !== process.env.NODE_ENV && (function() {
		...
		"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
		var React = require_react$1(), objectIs = "function" === typeof Object.is ? Object.is : is, useState = React.useState, useEffect = React.useEffect, useLayoutEffect = React.useLayoutEffect, useDebugValue = React.useDebugValue, didWarnOld18Alpha = !1, didWarnUncachedGetSnapshot = !1, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
		exports.useSyncExternalStore = void 0 !== React.useSyncExternalStore ? React.useSyncExternalStore : shim;
		"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(Error());
	})();
}));
...
//#endregion
//#region ../node_modules/.pnpm/react-i18next@17.0.6_i18next@26.0.8_typescript@5.9.2__react-dom@19.2.7_react@19.2.7__react@19.2.7_typescript@5.9.2/node_modules/react-i18next/dist/es/useTranslation.js
...
var useTranslation = (ns, props = {}) => {
	...
	const { i18n: i18nFromContext, defaultNS: defaultNSFromContext } = (0, import_react$1.useContext)(I18nContext) || {};
	...
	const i18nOptions = (0, import_react$1.useMemo)(() => ({
		...getDefaults(),
		...i18n?.options?.react,
		...props
	}), [i18n, props]);
	...
	const namespaces = (0, import_react$1.useMemo)(() => unstableNamespaces, unstableNamespaces);
	i18n?.reportNamespaces?.addUsedNamespaces?.(namespaces);
	const revisionRef = (0, import_react$1.useRef)(0);
	const subscribe = (0, import_react$1.useCallback)((callback) => {
	...
	const snapshotRef = (0, import_react$1.useRef)();
	const getSnapshot = (0, import_react$1.useCallback)(() => {
	...
	const [loadCount, setLoadCount] = (0, import_react$1.useState)(0);
	...
	const wrapperRef = (0, import_react$1.useRef)(null);
	const wrapperLangRef = (0, import_react$1.useRef)();
	...
	const ret = (0, import_react$1.useMemo)(() => {
...
function BooleanQuickSettingControl({ settingKey, isHovered }) {
	const [value, setValue] = (0, import_react$1.useState)(Settings[settingKey]);
	(0, import_react$1.useEffect)(() => {
...
function QuickSettingButton({ settingKey, isHovered }) {
	const { t } = useTranslation("settings");
	const [showDialog, setShowDialog] = (0, import_react$1.useState)(false);
	const settingType = QuickSettingsManager.getSettingType(settingKey);
	const [boolValue, setBoolValue] = (0, import_react$1.useState)(settingType === "boolean" ? Settings[settingKey] : false);
	(0, import_react$1.useEffect)(() => {
	...
	const Icon = settingsIcons[settingKey] ?? import_react$1.Fragment;
	const title = t(`${settingKey}.title`);
	const description = t(`${settingKey}.description`);
	if (Icon === import_react$1.Fragment) return null;
...
function RightToolbar() {
	const [quickSettings, setQuickSettings] = (0, import_react$1.useState)([]);
	const [isHovered, setIsHovered] = (0, import_react$1.useState)(false);
...
function ToolbarContent() {
	...
	const [isClassroomMode] = useAtom(isClassroomModeAtom);
	const [leftMouseMode, setLeftMouseMode] = (0, import_react$1.useState)(Settings.mouseLeftMode);
	(0, import_react$1.useEffect)(() => {
...
var DrawingColorLine = () => {
	const [userColorList, setUserColorList] = (0, import_react$1.useState)([]);
	const [currentDrawColor, setCurrentDrawColor] = (0, import_react$1.useState)(Color.Transparent);
	(0, import_react$1.useEffect)(() => {
...
var Project = class Project extends Tab {
	...
	*/
	...
	containerRef = import_react$1.createRef();
	/**
	* 立刻加载一个新的服务
	*/
	loadService(service) {
	...
	getComponent() {
		...
		const self = this;
		this.currentComponent = class extends import_react$1.Component {
...
//#endregion
export { createTabGroup as $, CaseSensitive as $i, useComposedRefs as $n, PanelRightOpen as $r, DropdownMenuTrigger as $t, DialogHeader as A, HardDriveDownload as Ai, flip as An, SquareDashed as Ar, Toolbar as At, activeResourceTabAtom as B, FileImage as Bi, useCallbackRef$1 as Bn, ScanText as Br, TooltipTrigger as Bt, SelectTrigger as C, listen as Ca, Layers as Ci, Presence as Cn, Tally4 as Cr, Overlay as Ct, DialogClose as D, ImageMinus as Di, Content$1 as Dn, Square as Dr, Trigger$1 as Dt, Dialog as E, ImageUpscale as Ei, Arrow as En, SunMoon as Er, Title as Et, writeText as F, Gauge as Fi, DismissableLayer as Fn, Space as Fr, ToolbarSplitButtonPrimary as Ft, isWindowMaxsizedAtom as G, Contrast as Gi, createSlot as Gn, RefreshCcw as Gr, DropdownMenuGroup as Gt, commandPaletteVisibleAtom as H, Delete as Hi, Switch as Hn, Scaling as Hr, DropdownMenu as Ht, Textarea as I, Fullscreen as Ii, Item$1 as In, Slash as Ir, ToolbarSplitButtonSecondary as It, tabGroupRootAtom as J, CircleDot as Ji, usePrevious as Jn, PictureInPicture2 as Jr, DropdownMenuRadioGroup as Jt, store as K, Clipboard as Ki, createSlottable as Kn, Ratio as Kr, DropdownMenuItem as Kt, Input as L, Folder as Li, Root$6 as Ln, Skull as Lr, Tooltip as Lt, readImage as M, HandMetal as Mi, useFloating as Mn, SquareArrowDownRight as Mr, ToolbarGroup as Mt, readText as N, HandGrab as Ni, autoUpdate as Nn, Spline as Nr, ToolbarMenuGroup as Nt, DialogContent as O, Hourglass as Oi, Root2$2 as On, SquarePen as Or, WarningProvider as Ot, writeImage as P, Grip as Pi, isElement as Pn, SplinePointer as Pr, ToolbarSplitButton as Pt, FIXED_SIDE_GROUP_IDS as Q, Check as Qi, composeRefs as Qn, Pause as Qr, DropdownMenuSubTrigger as Qt, activeDockedTabAtom as R, File as Ri, createRovingFocusGroupScope as Rn, ShieldCheck as Rr, TooltipContent$1 as Rt, SelectItem as S, emitTo as Sa, Lightbulb as Si, useFocusGuards as Sn, TextAlignJustify as Sr, Description as St, clamp as T, Keyboard as Ti, Anchor as Tn, Sun as Tr, Root$1 as Tt, currentUserAtom as U, Database as Ui, Primitive$1 as Un, RotateCw as Ur, DropdownMenuCheckboxItem as Ut, activeTabAtom as V, Eye as Vi, useId as Vn, ScanEye as Vr, Separator as Vt, isDevAtom as W, Crosshair as Wi, Slot$3 as Wn, RefreshCcwDot as Wr, DropdownMenuContent as Wt, useAtom as X, ChevronRight as Xi, useLayoutEffect2 as Xn, Pentagon as Xr, DropdownMenuSub as Xt, tabsAtom as Y, ChevronUp as Yi, useControllableState as Yn, Percent as Yr, DropdownMenuRadioItem as Yt, useAtomValue as Z, ChevronDown as Zi, createContextScope as Zn, Pencil as Zr, DropdownMenuSubContent as Zt, instance as _, isWeb as _a, ListMusic as _i, createMenuScope as _n, Undo as _r, transformImage as _t, loadWithProjectOwnership as a, ArrowRightFromLine as aa, Mouse as ai, Group$1 as an, cx as ar, removeTabFromGroups as at, SelectContent as b, TauriEvent as ba, ListCheck as bi, hideOthers as bn, Timer as br, Close as bt, sleep as c, AppWindowMac as ca, MousePointerClick as ci, Label as cn, settingsIcons as cr, updateTabSplitSizes as ct, require_md5 as d, createStore$1 as da, Moon as di, RadioItem as dn, X as dr, isResourceTab as dt, Calculator as ea, Palette as ei, DropdownMenuItemIndicator as en, composeEventHandlers as er, findTabGroup as et, Decoder as f, family as fa, Minus as fi, Root3 as fn, WholeWord as fr, Telemetry as ft, require_shim as g, isMac as ga, ListRestart as gi, SubTrigger as gn, Ungroup as gr, Image as gt, useTranslation as h, isLinux as ha, ListTree as hi, SubContent as hn, Unlink as hr, getVersion as ht, ProjectOwnershipError as i, ArrowRight as ia, Move3d as ii, Content2$2 as in, cva as ir, isFixedSideGroupId as it, DialogTitle as j, Hand as ji, offset as jn, SquareArrowUpLeft as jr, ToolbarButton as jt, DialogDescription as k, HardDrive as ki, createPopperScope as kn, SquareM as kr, createDialogScope as kt, open as l, AlignStartVertical as la, MouseOff as li, Portal$2 as ln, ZoomOut as lr, ComponentTab as lt, ColorManager as m, isIpad as ma, LoaderPinwheel as mi, Sub as mn, VenetianMask as mr, getDeviceId as mt, ProjectState as n, Blend as na, MoveVertical as ni, Arrow2 as nn, buttonVariants as nr, getTabGroups as nt, classifyBuiltInToolRuntimeError as o, ArrowDownNarrowWide as oa, MouseRight as oi, Item2$1 as on, Slot$4 as or, splitTabGroup as ot, Encoder as p, isDesktop as pa, MessageSquareText as pi, Separator$2 as pn, Waypoints as pr, getAppVersion as pt, tabDropTargetAtom as q, Circle as qi, useSize as qn, Presentation as qr, DropdownMenuPortal as qt, service as r, ArrowUpDown as ra, MoveHorizontal as ri, CheckboxItem as rn, cn as rr, insertTabIntoGroup as rt, AIProjectReferenceStore as s, AppWindow as sa, MousePointer as si, ItemIndicator$1 as sn, QuickSettingsManager as sr, updateTabGroup as st, Project as t, Bug as ta, Move as ti, Anchor2 as tn, Button$1 as tr, findTabGroupByTabId as tt, save as u, createLucideIcon as ua, MouseLeft as ui, RadioGroup as un, ZoomIn as ur, Tab as ut, Slider as v, isWindows as va, ListEnd as vi, ReactRemoveScroll as vn, Turtle as vr, FeatureFlags as vt, SelectValue as w, once as wa, Languages as wi, Portal$4 as wn, Tag as wr, Portal$1 as wt, SelectGroup as x, emit as xa, LineSquiggle as xi, FocusScope as xn, TextCursorInput as xr, Content as xt, Select as y, LazyStore as ya, ListCollapse as yi, __awaiter as yn, TrendingUpDown as yr, getOriginalNameOf as yt, activeGroupIdAtom as z, FileStack as zi, useDirection as zn, Shapes as zr, TooltipProvider as zt };
