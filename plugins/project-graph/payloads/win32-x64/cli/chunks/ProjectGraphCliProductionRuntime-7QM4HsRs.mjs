import { c as prepareBuiltInToolInvocation } from "./BuiltInToolRegistry-B4jwgOBk.mjs";
...
function invokeClosedProjectToolInProduction(options) {
	return runClosedProjectRuntime(async () => {
		const { invokeClosedProjectTool, loadPrecompiledClosedProjectModule } = await import("./ClosedProjectInvocation-DgpRLpzA.mjs");
